...
<html lang="en">
  ...
  <body>
    ...
    <div class="navigationbar">
        ...
        <div class="loginbtn">
            <button type="button" class="btn btn-ml-3 btn-outline-light" data-bs-toggle="modal" data-bs-target="#loginportal">
                Login <i class="fa fa-lg fa-user"></i>
            </button>
        </div>
        <!-- Modal -->
        <div class="modal fade" id="loginportal" tabindex="-1" aria-hidden="false">
                ...
                <div class="modal-body">
                    ...
                    ?>
                        <form class="form" method="post" name="login">
                            ...
                            <p class="link">Don't have an account? <a href="registerhome.php">Register Now</a></p>
                    </form>
                    <?php
                        }
                    ?>
